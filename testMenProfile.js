...
var menProfile_1 = require("./models/menProfile");
...
function createTestProfile() {
    return __awaiter(this, void 0, void 0, function () {
        var testProfile, savedProfile, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    testProfile = new menProfile_1.default({
                    ...
                    return [4 /*yield*/, testProfile.save()];
                case 1:
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error("❌ Error creating test profile:", error_1);
                    mongoose_1.default.connection.close();
                    return [3 /*break*/, 3];
